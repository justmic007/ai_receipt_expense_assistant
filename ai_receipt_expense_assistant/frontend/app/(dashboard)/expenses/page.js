...
// import { TrendingUp, CreditCard, Tag, Edit2, Check, X } from "lucide-react";
...
//                                                 )}
//                                             </td>
//                                             <td style={{ padding: "12px 16px", textAlign: "right", fontWeight: 600, color: "var(--text-primary)", whiteSpace: "nowrap" }}>
//                                                 {editingId === expense.id ? (
//                                                     <input type="number" value={editData.amount} onChange={(e) => setEditData({ ...editData, amount: parseFloat(e.target.value) })} style={{ ...inputStyle, width: 100, textAlign: "right" }} />
//                                                 ) : (
...
//                                                         <button onClick={() => saveEdit(expense.id)} disabled={isPending} style={{ padding: 6, border: "none", background: "var(--success-bg)", borderRadius: "var(--radius-sm)", cursor: "pointer", display: "flex", alignItems: "center" }}>
//                                                             <Check size={13} color="var(--success-text)" />
//                                                         </button>
//                                                         <button onClick={() => setEditingId(null)} style={{ padding: 6, border: "none", background: "var(--error-bg)", borderRadius: "var(--radius-sm)", cursor: "pointer", display: "flex", alignItems: "center" }}>
//                                                             <X size={13} color="var(--error-text)" />
//                                                         </button>
//                                                     </div>
//                                                 ) : (
//                                                     <button onClick={() => startEdit(expense)} style={{ padding: 6, border: "none", background: "transparent", borderRadius: "var(--radius-sm)", cursor: "pointer", display: "flex", alignItems: "center", color: "var(--text-muted)" }}
